...
<script>
  ...
  const newsletterForm = document.getElementById('search');
  ...
  if (newsletterForm) {
    newsletterForm.addEventListener('submit', function(e) {
      ...
      const existingMessages = this.parentNode.querySelectorAll('.form-message');
      existingMessages.forEach(msg => msg.remove());
      
      // Get the email input
      const emailInput = this.querySelector('input[type="address"]');
      ...
      if (email && email.includes('@') && email.includes('.')) {
        // Success message
        message.textContent = "You are registered! You won't miss any updates!";
        ...
        message.style.color = '#f44336'; // Red color
        message.style.backgroundColor = '#ffebee'; // Light red background
        emailInput.focus(); // Focus back on the input field
      }
